package com.nineinfosys.heatconverter.LoginActivity;
...
import com.nineinfosys.heatconverter.MainActivity;
import com.nineinfosys.heatconverter.R;
import com.nineinfosys.heatconverter.models.User;
...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setBackgroundDrawable(new ColorDrawable(Color.parseColor("#f7922c")));
